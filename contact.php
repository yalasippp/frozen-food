                    ...
                    <div class="box" id="contact">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <ul>
                                    <li><strong><a href="mailto:">FrozenFood@mail.com</a></strong>
                                    </li>
                                </ul>
                            </div>
                            <!-- /.col-sm-4 -->
...
<script>
    function initialize() {
        var mapOptions = {
            zoom: 15,
            center: new google.maps.LatLng(-7.125491,112.722746),
        ...
        var myLatLng = new google.maps.LatLng(-7.125491,112.722746);
