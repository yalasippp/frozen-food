                    ...
                    <div class="col-md-3">
                        <div class="panel panel-default sidebar-menu">
                            ...
                            <div class="panel-body" align="center" style="min-height: 345px; max-height: 345px;">
                                <img src="foto_profil/<?php echo $data['foto_profil'];?>" onerror="this.src='foto_profil/default.jpeg';" align="center" class="img-circle" width="100%" style="min-height: 235px; max-height: 235px;">
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <img src="foto_profil/<?php echo $data['foto_profil'];?>" onerror="this.src='foto_profil/default.jpeg';" width="100">
                                                    </div>
                                                    <div class="form-group">
