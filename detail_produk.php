...
include 'protect.php';
$id_produk=$_GET['id'];
$query=$conn->query("SELECT * FROM produk JOIN kategori ON produk.id_kategori=kategori.id_kategori WHERE id_produk='$id_produk'");
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse" id="navigation">
                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li class="active"> <a href="kategori.php">Categories</a>
                    </li>
            ...
            <div class="container">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked category-menu">
                                ...
                                while ($data2=$query2->fetch_assoc()) {
                                    ?>
                                <li>
                                    <a href="kategori.php?id=<?php echo $data2['id_kategori']; ?>"><?php echo $data2['nama_kategori']; ?></a>
                                </li>
                                    <?php
                                }
                                ?>
                ...
                <div class="col-md-9">
                    ...
                    <div class="row" id="productMain">
                        ...
                        <div class="col-sm-6">
                            <div class="box">
                                <h2 class="text-center"><?php echo $data['nama_produk']; ?> (<?php echo $data['nama_kategori']; ?>)</h2>
