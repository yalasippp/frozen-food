            ...
            <div class="container">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked category-menu">
                                ...
                                while ($data=$query->fetch_assoc()) {
                                    ?>
                                <li>
                                    <a href="kategori.php?id=<?php echo $data['id_kategori']; ?>"><?php echo $data['nama_kategori']; ?></a>
                                </li>
                                    <?php
                                }
                                ?>
                ...
                <div class="col-md-9">
                    <div class="box">
                        ...
                        <?php 
                        $id_kategori=$_GET['id'];
                        $query2=$conn->query("SELECT * FROM kategori WHERE id_kategori=$id_kategori");
                        $data2=$query2->fetch_assoc();
                        ?>
                        <h1><?php echo $data2['nama_kategori']; ?></h1>
                        </div>
                    <div class="row products">
                        <?php
                        $id_kategori=$_GET['id'];  
                        $query3=$conn->query("SELECT * FROM produk WHERE id_kategori=$id_kategori");
