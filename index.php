...
<head>
    ...
    <title>
         FrozenFood : Infromasi Pengiriman Pesanan FrozenFood
    </title>
    ...
    <div class="container">
        <div class="navbar-header">
                ...
                <a class="navbar-brand home" href="index.php" data-animate-hover="bounce">
                    ...
                    <img src="logo.png" class="visible-xs"><span class="sr-only">FrozenFood - go to homepage</span>
                </a>
            ...
            <div class="navbar-collapse collapse" id="navigation">
                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li> <a href="kategori.php">Categories</a>
                    </li>
        ...
        <div class="same-height-row">
            <div class="col-sm-4">
                <div class="box same-height">
                    ...
                    <h3>Rating</h3>
                    <p>Berikan bintang kepada produk FrozenFood yang kamu sukai</p>
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="box same-height">
                    ...
                    <h3>Special for Semua Orang Di Area Telang</h3>
                    <p>Aplikasi ini di khususkan untuk informasi FrozenFood di kawasan Area Telang.</p>
                </div>
            </div>
            ...
            <div class="col-sm-4">
                <div class="box same-height">
                    ...
                    <p>Aplikasi ini akan memberikan informasi lengkap mengenai produk FrozenFood pada Area Telang</p>
                </div>
            </div>
        </div>
        <!-- /.row -->
...
<div class="box text-center" data-animate="fadeInUp">
    <div class="container">
        <div class="col-md-12">
            <h3 class="text-uppercase"> FrozenFood sangat disukai oleh para remaja. </h3>

            <p class="lead">Penasaran dengan FrozenFood kami? <a href="warung.php">Check our Store!</a>
            </p>
        </div>
    </div>
</div>
...
<!-- /#content -->
 ...
 <div id="copyright">
    <div class="container">
        <div class="col-md-6">
            <p class="pull-left">© FrozenFood 2023</p>
        </div>
        <div class="col-md-6">
